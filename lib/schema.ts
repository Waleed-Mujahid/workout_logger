...
const CardioWorkoutSchema = z.object({
  ...
  duration: z.number(), // in minutes
  distance: z.number().optional(), // in kilometers or miles
...
const WorkoutStatsSchema = z.object({
  ...
  total_time_spent: z.number(), // in hours
  total_calories_burned: z.number(),
  total_weight_lifted: z.number().optional(), // in kg or lbs
});
...
const WorkoutTrackerAppSchema = z.object({
  ...
  exerciseLibrary: z.array(ExerciseSchema),
